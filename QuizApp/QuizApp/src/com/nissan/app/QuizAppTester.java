	...
	public static void main(String[] args) {
		try (Scanner scan = new Scanner(System.in);
			...
			while (loop) {
				...
				System.out.println("1. to start the quiz");
				System.out.println("2. to see your report");
				...
				case 2:
					System.out.println("Displaying your's quiz report.........");
					System.out
							.println("=================================================================================================================================================================================================");
					System.out.printf("%-40s", name + "'s Quiz Report\n");
					System.out
							.println("===================================================================================================================================================================================================");
					System.out.println(String.format("%-20s%20s%50s%40s%40s",
